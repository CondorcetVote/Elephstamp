> CondorcetVote \ [ElephStamp](../../readme.md) \ **Append**
# Class Append
> [Read it at source](https://github.com/CondorcetVote/ElephStamp/blob/main/src/src/Operation/Append.php#L10)
...
| TAG | `public const string TAG = 'ð'` | __ |
...
```php
final class CondorcetVote\ElephStamp\Operation\Append extends CondorcetVote\ElephStamp\Operation\BinaryOperation
{
    // Constants
    public const string TAG = 'ð';
    // Inherited Constants
