> CondorcetVote \ [ElephStamp](../../readme.md) \ **Ripemd160**
# Class Ripemd160
> [Read it at source](https://github.com/CondorcetVote/ElephStamp/blob/main/src/src/Operation/Ripemd160.php#L10)
...
```php
final class CondorcetVote\ElephStamp\Operation\Ripemd160 extends CondorcetVote\ElephStamp\Operation\HashOperation
{
    // Constants
